...
async function updateProduct(id, name, desc, img, price) {
...
export { readProducts, createProduct, deleteProduct, createUser, getUserByName, logout, updateProductStatus, readSomeProducts, updateProduct };