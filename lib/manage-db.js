...
async function createProduct(name, desc, img, price, status, stock, cost, visibility) {
...
async function updateProduct(id, name, desc, img, price, stock, cost, visibility) {
    const data = {
        name,
        desc,
        img,
